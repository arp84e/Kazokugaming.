    ...
    <header class="border-b border-violet-900/30 bg-[#03040b]/90 backdrop-blur-xl sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-8 items-center">
                <a href="${prefix}index.html" class="text-sm font-semibold text-slate-300 hover:text-violet-400 transition">Inicio</a>
            ...
            <div class="flex-1 max-w-xs ml-8 relative hidden lg:block">
                <input type="text" id="buscador-global-desktop" placeholder="Buscar juego, guía o noticia..." class="w-full bg-slate-900/50 border border-slate-700 text-slate-200 text-sm rounded-full pl-4 pr-4 py-2 focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition shadow-inner">
            </div>

            <button id="mobile-menu-btn" class="md:hidden text-slate-300 hover:text-violet-400 focus:outline-none p-2 relative z-50">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-[#050610] border-b border-violet-900/30 absolute w-full left-0 top-16 shadow-2xl">
            <nav class="flex flex-col px-6 pt-4 pb-8 space-y-5">
                <a href="${prefix}index.html" class="text-base font-semibold text-slate-300 hover:text-violet-400 transition">Inicio</a>
                <a href="${prefix}noticias.html" class="text-base font-semibold text-slate-300 hover:text-violet-400 transition">Noticias</a>
                <a href="${prefix}juegos.html" class="text-base font-semibold text-slate-300 hover:text-violet-400 transition">Juegos</a>
                <a href="${prefix}guias.html" class="text-base font-bold text-emerald-400 hover:text-emerald-300 transition">Guías</a>
                <a href="${prefix}radar.html" class="text-base font-semibold text-slate-300 hover:text-violet-400 transition">Radar</a>
                
                <div class="pt-5 mt-2 border-t border-slate-800">
                    <input type="text" id="buscador-global-mobile" placeholder="Buscar en KazokuGaming..." class="w-full bg-slate-900 border border-slate-700 text-slate-200 text-sm rounded-lg px-4 py-3 focus:outline-none focus:border-violet-500 transition">
                </div>
            </nav>
        </div>
    </header>
