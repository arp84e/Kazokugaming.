// header.js - Componente de Navegación Actualizado para el Universal Hub
document.addEventListener("DOMContentLoaded", function() {
    // Detectamos si estamos en la carpeta raíz o dentro de una subcarpeta para que los enlaces no se rompan
    ...
    <header class="border-b border-slate-800/80 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-8 items-center">
                ...
                <a href="${prefix}hub.html" class="text-sm font-semibold text-slate-300 hover:text-cyan-400 transition flex items-center gap-2">
                ...
                <a href="${prefix}foro.html" class="text-sm font-semibold text-slate-300 hover:text-cyan-400 transition">Foro</a>
            </nav>

            <div class="flex-1 max-w-xs ml-8 relative hidden lg:block">
                <input type="text" id="buscador-global" placeholder="Buscar jugador, ID o artículo..." class="w-full bg-slate-950 border border-slate-800 text-slate-200 text-sm rounded-full pl-4 pr-4 py-2 focus:outline-none focus:border-cyan-500 transition">
            </div>
