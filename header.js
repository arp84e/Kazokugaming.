// header.js - Componente de Navegación Global Actualizado (Responsive Multidispositivo)
document.addEventListener("DOMContentLoaded", function() {
    ...
    <header class="border-b border-slate-800/80 bg-slate-900/90 backdrop-blur-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex-1 max-w-xs ml-8 relative hidden lg:block">
                <input type="text" id="buscador-global-desktop" placeholder="Buscar..." class="w-full bg-slate-950 border border-slate-800 text-slate-200 text-sm rounded-full pl-4 pr-4 py-2 focus:outline-none focus:border-cyan-500 transition">
            </div>
    ...
    if (container) {
        ...
        // Lógica de interactividad para el menú móvil
