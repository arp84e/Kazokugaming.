    ...
    <header class="border-b border-indigo-900/50 bg-[#0a0a0f]/95 backdrop-blur-xl sticky top-0 z-50 shadow-[0_4px_30px_rgba(79,70,229,0.15)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
            ...
            <nav class="hidden md:flex space-x-8 items-center bg-slate-900/50 px-6 py-2 rounded-full border border-slate-800">
                <a href="${prefix}partidas.html" class="text-sm font-bold text-slate-300 hover:text-indigo-400 transition flex items-center gap-2">🎯 Partidas</a>
                ...
                <a href="${prefix}web3.html" class="text-sm font-bold text-amber-400 hover:text-amber-300 transition flex items-center gap-2">💎 Premios Web3</a>
            </nav>

            <div class="hidden lg:flex items-center gap-4">
                <button class="text-sm font-semibold text-slate-300 hover:text-white transition">Iniciar Sesión</button>
                <button class="px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-indigo-500/25 hover:scale-105">
                    + Crear Evento
                </button>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-[#0a0a0f] border-b border-indigo-900/50 absolute w-full left-0 top-20 shadow-2xl backdrop-blur-xl">
            <nav class="flex flex-col px-6 pt-4 pb-8 space-y-4">
                <a href="${prefix}partidas.html" class="text-base font-bold text-slate-300">🎯 Buscar Partidas</a>
                ...
                <a href="${prefix}web3.html" class="text-base font-bold text-amber-400">💎 Wallet & Premios</a>
                <hr class="border-slate-800">
                <button class="w-full py-3 bg-indigo-600 text-white font-bold rounded-xl mt-4">Conectar Cuenta</button>
            </nav>
        </div>
    </header>`;
